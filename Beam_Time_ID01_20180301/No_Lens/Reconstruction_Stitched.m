...
for i = 1:cyc
    % HIO
    [field,object,chi_square_real,chi_square_reci] = cycle(1,iterHIO,beta,epsilon,data_input,support,field,object,mask,chi_square_real,chi_square_reci);
    % ER
    [field,object,chi_square_real,chi_square_reci] = cycle(2,iterER,beta,epsilon,data_input,support,field,object,mask,chi_square_real,chi_square_reci);
    % Shrinkwrap
...
figure(10);
saveas(gcf,['Error_Metric_Stitched_' timestr(3) '_' num2str(round(chi_square_reci(end)),'%.0f') '.png']);
...
save(['Reconstruction_Stitched_' timestr(3) '_' num2str(round(chi_square_reci(end)),'%.0f') '.mat'],...
