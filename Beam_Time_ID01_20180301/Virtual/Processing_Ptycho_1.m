...
load('Reconstruction_Ptycho_1_2018_07_23_14_12_129.mat');
...
% Flip the object
%rho = conj(flip(flip(flip(rho,1),2),3));
...
if sav
    ...
    vid = VideoWriter('Virtual_Ptycho_1.mp4','MPEG-4');
    vid.FrameRate = 60;
    open(vid);
    writeVideo(vid,mov);
    close(vid);
...
save('Corrected_Virtual_Ptycho_1.mat','rho','rx','ry','rz');
