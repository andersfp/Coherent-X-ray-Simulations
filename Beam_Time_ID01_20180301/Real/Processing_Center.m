...
load('Reconstruction_Center_2018_03_19_17_24_363.mat');
...
object_avg = conj(flip(object_avg,3));
...
image(s.*rx,s.*ry,rgb);
axis equal tight;
set(gca,'YDir','normal','XLim',[-500 500],'YLim',[-400 200],'XTick',-400:200:400,'YTick',-300:100:100,'FontSize',16);
xlabel('x [nm]');
ylabel('y [nm]');
...
save('Corrected_Real_Center.mat','object_avg','rx','ry','rz');
