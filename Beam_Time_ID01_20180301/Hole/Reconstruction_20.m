...
I = h5read([p 'Scan0033.cxi'],'/entry_1/instrument_1/detector_1/data');
load('MaxiPix_Mask.mat');
toc;

% Load additional mask due to the hole
mask2 = imread('Mask_20.png');
...
figure(10);
saveas(gcf,['Error_Metric_20_' timestr(3) '_' num2str(round(chi_square_reci(end)),'%.0f') '.png']);
...
save(['Reconstruction_20_' timestr(3) '_' num2str(round(chi_square_reci(end)),'%.0f') '.mat'],...
