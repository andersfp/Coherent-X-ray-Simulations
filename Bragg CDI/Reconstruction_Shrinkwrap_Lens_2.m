...
load([p 'Lowres_Lens_Shrinkwrap_2.mat']);
...
figure(10);
saveas(gcf,'Error_Metric_Shrinkwrap_Lens_2.png');
...
save_binary([p 'Reconstruction_Lens_Shrinkwrap_2_object_xyz.bin'],object_xyz);
save_binary([p 'Reconstruction_Lens_Shrinkwrap_2_object.bin'],object);
save_binary([p 'Reconstruction_Lens_Shrinkwrap_2_object_avg_xyz.bin'],object_avg_xyz);
save_binary([p 'Reconstruction_Lens_Shrinkwrap_2_object_avg.bin'],object_avg);
save_binary([p 'Reconstruction_Lens_Shrinkwrap_2_field.bin'],field);
save_binary([p 'Reconstruction_Lens_Shrinkwrap_2_support.bin'],support);

% Save the error metrics
save([p 'Reconstruction_Lens_Shrinkwrap_2_Error_Metrics.mat'],'chi_square_real','chi_square_reci');
