...
% Offset the phase
mp = sum(angle(L2(L2 ~= 0)))/sum(sum(sum(L2 ~= 0)));
L2 = L2.*exp(-1i*mp);
...
if sav == 1
    ...
    print([ps 'Reconstruction_Lens_2_Avg_XY.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Lens_2_Avg_XY.png'],'-dpng','-r600');
end
...
if sav == 1
    ...
    set(gcf,'Position',[pos(1) pos(2) pos(3) pos(4)]);
    set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    print([ps 'Reconstruction_Lens_2_Avg_ZY.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Lens_2_Avg_ZY.png'],'-dpng','-r600');
end
...
if sav == 1
    ...
    set(gcf,'Position',[pos(1) pos(2) pos(3) pos(4)]);
    set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    print([ps 'Reconstruction_Lens_2_Avg_XZ.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Lens_2_Avg_XZ.png'],'-dpng','-r600');
end
...
if sav == 1
    ...
    set(gcf,'Position',[pos(1) pos(2) pos(3) pos(4)]);
    set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    print([ps 'Reconstruction_Lens_2_Avg_XYZ.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Lens_2_Avg_XYZ.png'],'-dpng','-r600');
end
