...
load([p 'Lowres_Free_Space_Shrinkwrap_1.mat']);
...
figure(10);
saveas(gcf,'Error_Metric_Shrinkwrap_Free_Space_1.png');
...
save_binary([p 'Reconstruction_Free_Space_Shrinkwrap_1_object_xyz.bin'],object_xyz);
save_binary([p 'Reconstruction_Free_Space_Shrinkwrap_1_object.bin'],object);
save_binary([p 'Reconstruction_Free_Space_Shrinkwrap_1_object_avg_xyz.bin'],object_avg_xyz);
save_binary([p 'Reconstruction_Free_Space_Shrinkwrap_1_object_avg.bin'],object_avg);
save_binary([p 'Reconstruction_Free_Space_Shrinkwrap_1_field.bin'],field);
save_binary([p 'Reconstruction_Free_Space_Shrinkwrap_1_support.bin'],support);

% Save the error metrics
save([p 'Reconstruction_Free_Space_Shrinkwrap_1_Error_Metrics.mat'],'chi_square_real','chi_square_reci');
