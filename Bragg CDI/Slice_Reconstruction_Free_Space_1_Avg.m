...
%% Plot the data
% Flip the array
F1 = conj(flip(flip(flip(F1,1),2),3));

% Scale the data
F1 = 50*F1;

% Offset the phase
mp = sum(angle(F1(F1 ~= 0)))/sum(sum(sum(F1 ~= 0)));
F1 = F1.*exp(-1i*mp);
...
if sav == 1
    ...
    print([ps 'Reconstruction_Free_Space_1_Avg_XY.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Free_Space_1_Avg_XY.png'],'-dpng','-r600');
end
...
if sav == 1
    ...
    set(gcf,'Position',[pos(1) pos(2) pos(3) pos(4)]);
    set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    print([ps 'Reconstruction_Free_Space_1_Avg_ZY.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Free_Space_1_Avg_ZY.png'],'-dpng','-r600');
end
...
if sav == 1
    ...
    set(gcf,'Position',[pos(1) pos(2) pos(3) pos(4)]);
    set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    print([ps 'Reconstruction_Free_Space_1_Avg_XZ.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Free_Space_1_Avg_XZ.png'],'-dpng','-r600');
end
...
if sav == 1
    ...
    set(gcf,'Position',[pos(1) pos(2) pos(3) pos(4)]);
    set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
    print([ps 'Reconstruction_Free_Space_1_Avg_XYZ.pdf'],'-dpdf','-r0');
    print([ps 'Reconstruction_Free_Space_1_Avg_XYZ.png'],'-dpng','-r600');
end
